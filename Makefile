...
debug: build
	opam exec -- ocamldebug _build/default/lucid/main.bc

DOCS_PATH=docs/
DOCS_NAME=lucid
DOCS_DESCR=An interpreter for the Calculus of Inductive Constructions
...
<meta content="https://github.com/CharlesAverill/lucid" property="og:url" />
endef
...
docs: cleandocs build
	...
	mv $(DOCS_PATH)lucid/lucid.html $(DOCS_PATH)index.html
	mv $(DOCS_PATH)lucid $(DOCS_PATH)module
